...
/**
 * Tipo enumerativo que contiene los cuadros disponibles y un metodo de seleccion
 * @version 1.0
 * @author agust
 */
public enum Cuadro
{
     ...
     **/
    private Cuadro (String screenName)
    {
     ...
     **/
    public Cuadro selectCuadro ()
    {
        //Variables
        Scanner in = new Scanner (System.in);
        Cuadro[] array = Cuadro.values();
        int opcion;
